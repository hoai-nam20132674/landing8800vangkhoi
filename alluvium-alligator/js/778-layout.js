var wpAjaxUrl = 'http://vertu.com/wp-admin/admin-ajax.php';var flBuilderUrl = 'http://vertu.com/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'http://vertu.com/wp-content/plugins/bb-plugin/',
		wpAjaxUrl : 'http://vertu.com/wp-admin/admin-ajax.php'
	},
	breakpoints : {
		small  : 768,
		medium : 992	},
...
YUI({'logExclude': { 'yui': true } }).use('fl-slideshow', function(Y){
	...
	if( null === Y.one('.fl-node-59da818985a40 .fl-slideshow-container') ) {
		return;
	}

	var oldSlideshow = Y.one('.fl-node-59da818985a40 .fl-slideshow-container .fl-slideshow'),
		newSlideshow = new Y.FL.Slideshow({
			autoPlay: false,
						color: 'light',
						googlePlusButtonEnabled: true,
			height: 800,
			imageNavEnabled: true,
			likeButtonEnabled: true,
						navButtons: [],
			navButtonsLeft: ["prevPage"],
			navButtonsRight: ["nextPage"],
									navPosition: 'bottom',
			navType: 'thumbs',
...
thumbURL: "images/chitiet1.jpg",largeURL: "images/chitiet1.jpg",x3largeURL: "images/chitiet1.jpg",caption: ""},{
thumbURL: "images/chitiet2.jpg",largeURL: "images/chitiet2.jpg",x3largeURL: "images/chitiet2.jpg",caption: ""},{
thumbURL: "images/chitiet3.jpg",largeURL: "images/chitiet3.jpg",x3largeURL: "images/chitiet3.jpg",caption: ""},{
thumbURL: "images/chitiet4.jpg",largeURL: "images/chitiet4.jpg",x3largeURL: "images/chitiet4.jpg",caption: ""},{
thumbURL: "images/chitiet5.jpg",largeURL: "images/chitiet5.jpg",x3largeURL: "images/chitiet5.jpg",caption: ""}]}],
			speed: 3000,
			tweetButtonEnabled: true,
			thumbsImageHeight: 120,
			thumbsImageWidth: 120,
			transition: 'fade',
	...
	newSlideshow.render('.fl-node-59da818985a40 .fl-slideshow-container');

	Y.one('.fl-node-59da818985a40 .fl-slideshow-container').setStyle( 'height', 'auto' );
});
